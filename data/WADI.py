...
class WADI(Dataset):
    ...
    def __init__(self, fname, root=MyPath.db_root_dir('wadi'), train=True, transform=None, panomaly= None, sanomaly= None, sanomaly2=None, mean_data=None, std_data=None):
